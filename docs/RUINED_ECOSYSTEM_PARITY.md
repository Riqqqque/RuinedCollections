...
6. Do not force RuinedCollections to match RuinedWardrobe's runtime target unless the project requirement changes. RuinedCollections remains Paper/Folia `1.21` through `1.21.2` and Java `21+`.
...
| Build | Maven | Gradle |
| Java | 21+ | 25 |
| Platform | Paper/Folia 1.21 through 1.21.2 | Newer Paper/Folia target |
